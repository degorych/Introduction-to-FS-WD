...
<div class="1task">
    ...
    <div>
        <?php
        if (isset($_SESSION['sum'])) echo $_SESSION['sum'];
        ?>
    </div>
</div>
<div class="2task">
    ...
    <div>
        <?php
        if (isset($_SESSION['sum237'])) echo $_SESSION['sum237'];
        ?>
    </div>
</div>
<div class="3task">
    ...
    <div>
        <?php
        if (isset($_SESSION['star'])) echo $_SESSION['star'];
        ?>
    </div>
</div>
<div class="4task">
    ...
    <div class="chess-board">
        <?php
        if (isset($_SESSION['paintChess'])) echo $_SESSION['paintChess'];
        ?>
    </div>
</div>
<div class="5task">
    ...
    <div>
        <?php
        if (isset($_SESSION['digitSum'])) echo $_SESSION['digitSum'];
        ?>
    </div>
</div>
<div class="6task">
    ...
    <div>
        <?php
        if (isset($_SESSION['sortArray'])) print_r($_SESSION['sortArray']);
        session_destroy();
        ?>
    </div>
</div>
